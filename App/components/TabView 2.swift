...
class TabView: UIView {
    ...
    func configureTabs() {
        ...
        self.tabs.append(Tab(identifier: .groups,
                             normalImage: UIImage(named: "groups-i")!,
                             selectedImage: UIImage(named: "groups-a")!))
        
        self.tabs.append(Tab(identifier: .addKill,
                             normalImage: UIImage(named: "add")!,
    ...
    func setupView() {
        ...
        let navBump = UIImageView(image: UIImage(named: "nav"))
        //background.contentMode = .center
        self.addSubview(navBump)
        navBump.snp.makeConstraints { (make) in
